        ...
        <div className="row flex">
          ...
          <div className="col__2">
            <div className="meta">
              ...
              <p>
                At WEARCITY , we beleive there is a better way to do marketing. A more valuable, less invasive way where customers are earned rather than bought,We obsessively passionate about it, and outr mission is to sell products accross india
              </p>
            </div>
          </div>
        </div>
